...
export const addCampus = campus => dispatch => {
  axios.post('/api/campus', campus)
    ...
    .catch(err => console.error(`Creating campus: ${campus} failed`, err));
};
...
export const updateCampus = (id, campus) => dispatch => {
  axios.put(`/api/campus/${id}`, campus)
       ...
       .catch(err => console.error(`Updating campmus: ${campus} failed`, err));
};

export const removeCampus = id => dispatch => {
  dispatch(remove(id));
  axios.delete(`/api/campus/${id}`)
       .catch(err => console.error(`Removing campus: ${id} failed`, err));
};
