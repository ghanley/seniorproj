...
#DOCUMENT THINGS, WRITE A READ ME
...
- a student
```
curl -H "Content-Type: application/json" -X PUT -d '{"name":"LSU"}' http://localhost:1337/api/campus/2


`curl -H "Content-Type: application/json" -X GET -d '{"name":"kate","email":"1234@gmail.com"}' http://localhost:1337/api/students`

### How to test functionality without a frontend
- GET: use your browser
- POST / PUT / DELETE :
 - CLI (command line interface) with `curl`
   - e.g. `curl -H "Content-Type: application/json" -X POST -d '{"name":"Greg","email":"fjjfew@gmail.com}' http://localhost:1337/api/students/1`
